...
public class Gameboard {
    ...
    int holeCounter1;// = random.nextInt((26/2));
    int holeCounter2;// = (holeCounter1+(18%26)%26-4);
    ...
    public Gameboard() {
        ...
        this.holeCounter2 = (holeCounter1 + 13);
        winner = null;
        initFields();
    }
    ...
    public void insertFigureToGameboard(Spieler spieler, String spielerId, String card) {
        ...
        // Debugging-Ausgabe
        if (felder[beginningPosition].getSpielfigur() == addNewSpielfigur) {
